...
$res_query = mysql_db_query($dbnam, $research_query);
$res = mysql_fetch_array($res_query);

		if($res[r1] < $ur1 OR $res[r2] < $ur2 OR $res[r3] < $ur3 OR $res[r4] < $ur4 OR $res[r5] < $ur5 OR $res[r6] < $ur6 OR $res[r7] < $ur7 OR $res[r8] < $ur8 OR $res[r9] < $ur9 OR $res[r10] < $ur10 OR $res[r11] < $ur11 OR $res[r12] < $ur12 OR $res[r13] < $ur13)
		...
		elseif($ur1 > 0  AND $race == Giant)
			{echo"<div align=center><font class=yellow>You cannot research these items being that you are a Giant.</font></div>";include("include/S_CRES.php");die();
			}
