...
  ?> 		
					...
					<center><input type="submit" name="leave" value="Click here to confirm leaving" class=button>
					<input type="hidden" name="leave" value="4"></center></td>
	...
	{	
		...
		mysql_query("INSERT INTO setnews (date, news, setid) 
			VALUES	('$clock', '<font class=blue>Your settlement has left <b>$setguild</b>!</font>', '$setid') ");
						...
						echo"<div align=center>You have left $setguild!</font></div>";
