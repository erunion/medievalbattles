	<form method=post action="cresearch.php">
			<table border="0" bordercolor="#808080" align=center width="80%">
				<tr><td colspan=7 class=main><b class=top>Cancel Scientists</b></td>
				<tr><td colspan=7 class=main2>You currently have <?php  echo"$ascientists"; ?> scientists.</td>
				<tr>
					...
					<td class=main2><b class=reg>Scientists to Cancel</b></td>
<?
...
// pyrotechnics
	$pyro = "$res[r14pts]" . "/125,000";
		if($res[r14pts] >= 125000)	 { $pyro = "<i>Done</i>"; }
...
?>
	...
	<tr>
		<td class=inner2>Pyrotechnics</td>
		<td class=inner2>Unit</td>
		<td class=inner2><?php echo "$res[r14]"; ?></td>
		<td class=inner2><?php echo "$pyro"; ?></td>
		<td class=inner2><input type="number" name="ur14" size=8 maxlength=10></td>
	</table>
	<br><br>

<center><input  type="submit" name="first" value="Cancel">
