 ...
 <tr>
  <td><br>
   <table border="1" bordercolor="#000000" align=center width="80%" cellpadding=0 cellspacing=0>
	...
	<tr>
	 <td colspan=7 class=main2><? echo "It cost $b_cost gp to construct a building <br> You have $aland free land to build on"; ?></td>
	<tr><form method="post" action="buildings.php">
	 <td class=main2></td>
	...
	<tr>
	 ...
	 <td class=inner2><? echo "$home"; ?></td>
	 <td class=inner2><? echo "$dhome"; ?></td>
	 <td class=inner2><? echo "$max_land"; ?></td>
	 <td class=inner2><input type="number" name="uhome" size=5></td>
	<tr>
	 <td class=num>2</td>
	 <td class=inner2>Kennel</td>
	 <td class=inner2><? echo "$kennel"; ?></td>
	 <td class=inner2><? echo "$dkennel"; ?></td>
	 <td class=inner2><? echo "$max_land"; ?></td>
	 <td class=inner2><input type="number" name="ukennel" size=5></td>
	<tr>
	 <td class=num>3</td>
	 <td class=inner2>Barrack</td>
	 <td class=inner2><? echo "$barrack"; ?></td>
