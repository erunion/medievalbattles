...
$thenap = mysql_db_query($dbnam, "SELECT nap FROM settlement WHERE setid = '$setid'");	
...
<table border=0 width=\"60%\" align=center>
	...
	<tr>
		<td class=inner2><b class=other>Non-Agression Pacts (NAP):</b></td><td class=inner2><input type=text name="thenap" value="<? echo"$nap"; ?>" maxlength=20 size=20></td>
	<tr>
