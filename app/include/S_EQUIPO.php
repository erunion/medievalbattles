...
<form type=get action="equip.php">		
	 <table border=0 bordercolor="#808080" align=center width="80%">
	  ...
	  <tr>
		...
		<td class=inner2><? echo"$wizpower"; ?></td>
		<td class=inner2><? echo"$wizspeeds";?></td>
		<td class=inner2>
		   <center>
			<select name="uwizard">
				...
				<? if($r3pts >= 10000)echo"<option value=\"Cloud Kill\">Cloud Kill</option>"; ?>
			   </center>
              </select>
	 <tr>
		<td class=inner2><b>Priest</b></td>
		<td class=inner2><? echo"$cstaff"; ?></td>
		<td class=inner2><? echo"$pripower"; ?></td>
		<td class=inner2><? echo"$prispeedw"; ?></td>
		<td class=inner2>
		   <center>
		    <select name="upriest">
	         <option selected value="ns">-Choose a Weapon-</option>
