<?			  include("include/connect.php");
				...
				$theirtotalpower = (($twarpower * $ttwarriors) + ($twizpower * $ttwizards) + ($tpripower * $ttpriests) + ($tarchpower * $ttarchers) + ($awp * 5)) * $modifier;
				...
				$yourtotalpower = (($uwarrior * $warpower) + ($uwizard * $wizpower) + ($upriest * $pripower) + ($uarcher * $archpower)) * $ymodifier;
				$yourtotalpower = round($yourtotalpower);
